...
const MANAGEMENT: NavItem[] = [
  ...
  {
    // Brand config (stages / tags / dispositions / dial cap / followup
    // templates). Page itself is manager+ guarded; the link only
    // renders inside the Management section so agents never see it.
    href: '/settings',
    label: 'Settings',
    icon: ICON(
      <>
...
// Footer renders for everyone (agents included). Connections is the
// per-user OAuth screen — every member needs it.
